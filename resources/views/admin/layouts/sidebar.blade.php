<aside class="main-sidebar sidebar-light-success elevation-4">
    <!-- Brand Logo -->
    <a href="/redirect" class="brand-link">
      <img src="/shop.png" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
      <span class="brand-text font-weight text-success">SAYUR SHOP</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-4">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/redirect" class="nav-link {{ Request::is('redirect') ? 'active' : '' }}">
          ...
          <li class="nav-item mt-3">
            ...
            <ul class="nav nav-treeview my-3">
              <li class="nav-item">
